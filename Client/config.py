...
class Config:
    API_BASE_URL = os.getenv("SERVER_URL", "https://employee-monitoring.duckdns.org/api/v1")
    WS_BASE_URL = os.getenv("WS_URL", "wss://employee-monitoring.duckdns.org/api/v1/ws")
